...
The remaining gap in M3 coverage (Notch/EndoMT/vasculopathy: 21%, 5/24 detectable species) merits discussion. Integration of GSE195452 improved M3 from 17% to 21%, recovering PECAM1 from Vascular_ACKR1 and Vascular_RBP7 clusters, and NUMB from pericyte populations — meaningful progress. However, the core EndoMT circuitry remains partially transcriptomically silent. This is not a deficiency in map curation — M3 contains 22 hand-curated SSc-specific reactions supported by primary evidence — but a direct consequence of the biology: endothelial-to-mesenchymal transition is a transitional state in which endothelial cells progressively acquire SNAI2, ACTA2, and N-cadherin (CDH2) while losing CDH5. The key M3 hub NICD1 is a proteolytic cleavage product of NOTCH1, structurally undetectable by RNA-seq, and its downstream targets HEY1, DTX1, MAML1, and TLE1 are primarily post-translationally regulated in the transitional population. DLL4, EDNRA, and EDNRB are expressed in SSc vascular cells but did not reach differential significance at the pseudobulk level in any dataset, likely because EndoMT-committed cells constitute too small a fraction to shift the per-donor aggregate. Future improvement of M3 coverage will require targeted single-cell profiling of SSc digital ulcer biopsies or nailfold capillaroscopy-guided tissue, where vasculopathy and EndoMT are the dominant pathological processes.

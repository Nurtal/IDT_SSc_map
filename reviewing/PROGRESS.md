...
| E23 | README refresh | S7 | 🟢 done | README rewritten: 2026 ACR-timeline plan + risks + roles archived to `docs/planning/historical_roadmap.md` (with 2026-05-16 pivot note); new headline-numbers table (526/260/198/197/50 %); revision/v1.1 cycle linked from front matter; tech stack table updated with v1.1 backends (NB GLM + AUCell). |
...
- **2026-05-22** — **Continuation session — 6 additional E-items closed
  ...
  - **E11** — `make biomodels`: MIRIAM CVTerm injection via libSBML
    ...
    cover letter: `docs/release/biomodels_submission.md`. ID REPLACE_ME
...
- **2026-05-21 (morning)** — **Parallel quick-wins session** on `revision/v1.1`,
  ...
  - **E23 closed**: README rewritten for Phase 4c + revision-v1.1
    ...
    `docs/planning/historical_roadmap.md` (with 2026-05-16 pivot note);

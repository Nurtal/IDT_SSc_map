...
## v1.1 hardening sprint (2026-06-05)

> Added after an independent critical read flagged that several **headline numbers
> are stronger than the underlying SSc-specific curation layer**, and that the
> coverage metric is method-sensitive. This sprint quantifies and documents those
> gaps rather than papering over them — the defensible posture for the npj-SBA
> major revision. Five weak points, five mitigations; four are 🟢 AUTO and run
> offline from artefacts already in the repo, one is irreducibly 🔴 HUMAN.

| # | Weak point (reviewer-anticipated) | Mitigation | Lane | Output |
|---|-----------------------------------|------------|------|--------|
...
| H4 | Headline numbers diverge across files (526 vs 385 species, 260 vs 175 vs 85 reactions, 17 vs 20 compartments, 50 vs 81 %). | `docs/archive/NUMBERS_RECONCILIATION.md` — single canonical table mapping every published figure to its definition and source artefact; README headline gains an explicit provenance split. | 🟢 | `docs/archive/NUMBERS_RECONCILIATION.md`, README edit |

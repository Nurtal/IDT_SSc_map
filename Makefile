...
presentation:  ## Build the unified slide deck docs/presentation.md → docs/SSc_MIM_presentation.pdf.
	@if [ -x .venv/bin/python ]; then .venv/bin/python scripts/build_presentation.py; \
	else $(PYTHON) scripts/build_presentation.py; fi
